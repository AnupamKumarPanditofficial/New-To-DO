...
interface SetGroupPurposeDialogProps {
  isOpen: boolean;
  onOpenChange: (isOpen: boolean) => void;
  onPurposeSet: (purposeData: Partial<CollabGroup>) => void;
}

export default function SetGroupPurposeDialog({
  isOpen,
  onOpenChange,
  onPurposeSet,
}: SetGroupPurposeDialogProps) {
  ...
  const handleSubmit = () => {
    if (purpose === 'exams' && !examName.trim()) {
      // Basic validation
      alert('Please enter the name of the exam.');
      return;
    }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Set Group Purpose</DialogTitle>
          <DialogDescription>
            What is this collaboration group for? This will help tailor the experience.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          <Button onClick={handleSubmit}>Save Purpose</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
